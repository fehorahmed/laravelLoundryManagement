            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <form action="{{ route('admin.managedeliverymanstore') }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" id="nidnumber" value="{{ old('nidnumber') }}" class="form-control"
                                    name="nidnumber">
                            </div>
                            @error('nidnumber')
                                <div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" id="Status" value="{{ old('status') }}" class="form-control"
                                    name="status">
                            </div>
                            @error('status')
                                <div>
